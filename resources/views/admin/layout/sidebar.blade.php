    ...
    <div class="app-sidebar colored">
        <div class="sidebar-header">
            <a class="header-brand" href="{{url('/dashboard')}}">
                ...
                <span class="text">FFA Hastane</span>
            </a>
            ...
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            <a href="{{route('hekim.create')}}" class="menu-item">Create</a>
                            <a href="{{route('hekim.index')}}" class="menu-item">View</a>
                    ...
                    @if(auth()->check()&& auth()->user()->role->name === 'admin')
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Feedbacks</span> <span class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                            <a href="{{route('feedback.index')}}" class="menu-item">View</a>
